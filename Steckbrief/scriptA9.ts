...
window.addEventListener('load', function(){
    ...
    var btn2:HTMLElement = document.querySelector('#myBtn2');
    ...
    var btn3:HTMLElement = document.querySelector('#myBtn3');
    ...
    var btn4:HTMLElement = document.querySelector('#myBtn4');
    ...
    var btn5:HTMLElement = document.querySelector('#myBtn5');
    ...
    var btn6:HTMLElement = document.querySelector('#myBtn6');
    ...
    var btn7:HTMLElement = document.querySelector('#myBtn7');
    ...
    var btn8:HTMLElement = document.querySelector('#myBtn8');
