...
var A:HTMLAudioElement = new Audio('A.mp3');
var C:HTMLAudioElement = new Audio('C.mp3');
var F:HTMLAudioElement = new Audio('F.mp3');
var G:HTMLAudioElement = new Audio('G.mp3');
var hihat:HTMLAudioElement = new Audio('hihat.mp3');
var kick:HTMLAudioElement = new Audio('kick.mp3');
var snare:HTMLAudioElement = new Audio('snare.mp3');
var laugh1:HTMLAudioElement = new Audio('laugh-1.mp3');
var laugh2:HTMLAudioElement = new Audio('laugh-2.mp3');
